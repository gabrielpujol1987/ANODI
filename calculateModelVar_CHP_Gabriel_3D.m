function DistMtrx = calculateModelVar_CHP_Gabriel_3D(realizations, training_image_original, tempSize)
...
num_realizations = size(realizations,4);%3);
myResolution = 1;
...
nzS = size(training_image_original,3);
% nzS = 1;
...
parS.Dimz = size(realizations,3);	% 1;%
